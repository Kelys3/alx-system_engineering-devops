...
In our AirBnB clone project, I set up Nginx on ALX's web servers to run a Flask app using Gunicorn. I also created an Upstart script to ensure the app stays live even after server reboots.
## Tasks :page_with_curl:

* **0. Set up development with Python**
  * In this task, I configured the file `web_flask/0-hello_route.py` from my
  [AirBnB_clone_v2](https://github.com/Kelys3/AirBnB_clone_v2) to serve content
...
* **4. Let's do this for your API**
  * In this task, I configured the API from my [AirBnB_clone_v3](https://github.com/Kelys3/AirBnB_clone_v3) to run on Gunicorn.
